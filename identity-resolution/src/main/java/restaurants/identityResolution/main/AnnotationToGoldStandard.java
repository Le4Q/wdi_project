...
public class AnnotationToGoldStandard {
    ...
    public static void main(String[] args) {
        ...
        String inputPath = "data/output/test_correspondences_SM_detail_ZD.csv";
        String outputPathTrain = "data/goldstandard/gs_zomato_2_datafiniti_training";
        String outputPathTest = "data/goldstandard/gs_zomato_2_datafiniti_test";
