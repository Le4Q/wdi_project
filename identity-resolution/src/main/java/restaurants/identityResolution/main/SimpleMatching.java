...
import de.uni_mannheim.informatik.dws.wdi.ExerciseIdentityResolution.model.CSVRestaurantDetailFormatter;
...
public class SimpleMatching {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/test_correspondences_SM.csv"), correspondences);

        String annotationPath = "data/output/test_correspondences_SM_detail_ZD.csv";
