...
public class RestaurantPostalCodeComparatorLevenshtein implements Comparator<Restaurant, Attribute> {
    ...
    public RestaurantPostalCodeComparatorLevenshtein(){
        this.fn = ComparatorUtils::def;
    }
    public RestaurantPostalCodeComparatorLevenshtein(Function<String,String> fn){
        this.fn = fn;
    }
