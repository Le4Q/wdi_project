...
public class AcceptsReservationsEvaluationRule extends EvaluationRule<Restaurant, Attribute> {
    @Override
    public boolean isEqual(Restaurant record1, Restaurant record2, Attribute attribute) {
        return (record1.getAcceptsReservations() == record2.getAcceptsReservations());
    }
