...
public class StateEvlauationRule extends EvaluationRule<Restaurant, Attribute> {
    ...
    public boolean isEqual(Restaurant record1, Restaurant record2, Attribute attribute) {
        if(record1.getPostalAddress().getAddress() == null && record2.getPostalAddress().getAddress() == null)
            return true;
        else if(record1.getPostalAddress().getAddress() == null ^ record2.getPostalAddress().getAddress() == null)
            return false;
        else
            return sim.calculate(record1.getPostalAddress().getAddress(), record2.getPostalAddress().getAddress()) > 0.7;
    }
