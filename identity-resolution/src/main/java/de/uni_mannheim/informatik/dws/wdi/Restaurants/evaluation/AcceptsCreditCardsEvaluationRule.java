...
public class AcceptsCreditCardsEvaluationRule extends EvaluationRule<Restaurant, Attribute> {
    @Override
    public boolean isEqual(Restaurant record1, Restaurant record2, Attribute attribute) {
        return (record1.getAcceptsCreditCards() == record2.getAcceptsCreditCards());
    }
