...
import de.uni_mannheim.informatik.dws.wdi.Restaurants.blocker.SchemaOrgDuplicateDetectionBlockingKey;
...
public class SchemaOrgDuplicateDetection {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("identity-resolution/data/output/schemaOrg_duplicates.csv"), correspondences);
