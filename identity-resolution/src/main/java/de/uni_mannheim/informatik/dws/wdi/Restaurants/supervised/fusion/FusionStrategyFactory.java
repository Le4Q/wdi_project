...
public class FusionStrategyFactory<T> {
	...
	public ArrayList<SupervisedFusionFeature> createFusionStrategies(Attribute attribute, String getMethod, String setMethod, Class<T> class1, EvaluationRule<Restaurant, Attribute> evaluationRule) {
